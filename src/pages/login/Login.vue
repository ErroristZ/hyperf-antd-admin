...
import { loadPersonalAfterLoginRoutes } from '@/utils/routerUtil'
  ...
  methods: {
    ...
    afterLogin(res) {
      ...
      if (loginRes.code == 200) {
        ...
        loadPersonalAfterLoginRoutes(function () {
          that.$router.push('/dashboard/workplace')
        })
      } else {
        that.error = loginRes.message
        that.logging = false
      }
    }
  }
