<template>
  <a-layout :class="['admin-layout', 'beauty-scroll']">
    ...
    <a-layout class="admin-layout-main beauty-scroll">
      ...
      <personal-setting ref="PersonalSetting"></personal-setting>
    </a-layout>
  </a-layout>
</template>
...
export default {
  name: 'AdminLayout',
  components: { Setting, SideMenu, Drawer, PageFooter, AdminHeader, PersonalSetting },
  data() {
    return {
  ...
  methods: {
    ...
    personalSetting() {
      var that = this
      that.$refs.PersonalSetting.handleVisible()
    }
  },
  created() {
